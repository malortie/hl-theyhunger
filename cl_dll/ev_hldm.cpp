...
void EV_FireGlock1( event_args_t *args )
{
	...
	else
	{
		...
		{
		case 0: gEngfuncs.pEventAPI->EV_PlaySound(idx, origin, CHAN_WEAPON, "weapons/pl_gun1.wav", gEngfuncs.pfnRandomFloat(0.8, 0.9), ATTN_NORM, 0, PITCH_NORM); break;
		case 1: gEngfuncs.pEventAPI->EV_PlaySound(idx, origin, CHAN_WEAPON, "weapons/pl_gun2.wav", gEngfuncs.pfnRandomFloat(0.8, 0.9), ATTN_NORM, 0, PITCH_NORM); break;
		}
	}
...
void EV_Shovel( event_args_t *args )
{
	...
	if ( EV_IsLocal( idx ) )
	{
		...
		{
			case 0:
				gEngfuncs.pEventAPI->EV_WeaponAnimation( SHOVEL_ATTACK1MISS, 1 ); break;
			case 1:
				gEngfuncs.pEventAPI->EV_WeaponAnimation( SHOVEL_ATTACK2MISS, 1 ); break;
			case 2:
				gEngfuncs.pEventAPI->EV_WeaponAnimation( SHOVEL_ATTACK3MISS, 1 ); break;
		}
	}
}
...
void EV_Spanner( event_args_t *args )
{
	...
	if ( EV_IsLocal( idx ) )
	{
		...
		{
			case 0:
				gEngfuncs.pEventAPI->EV_WeaponAnimation( SPANNER_ATTACK1, 1 ); break;
			case 1:
				gEngfuncs.pEventAPI->EV_WeaponAnimation( SPANNER_ATTACK2, 1 ); break;
		}
	}
}
//======================
